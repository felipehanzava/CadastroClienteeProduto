package br.com.ebac.hz.mod19.cadastro;


import br.com.ebac.hz.mod19.dao.ClienteMapDAO;
import br.com.ebac.hz.mod19.dao.IClienteDAO;
import br.com.ebac.hz.mod19.dao.IProdutoDAO;
import br.com.ebac.hz.mod19.dao.ProdutoDAO;
import br.com.ebac.hz.mod19.dao.generic.IGenericDAO;
...
import br.com.ebac.hz.mod19.exception.TipoChaveNaoEncontradaException;
import br.com.ebac.hz.mod19.fabrica.FabricaPersistente;
import br.com.ebac.hz.mod19.fabrica.Factory;
import br.com.ebac.hz.mod19.fabrica.IFactory;
...
public class App2 {
    ...
    public static void main(String args[]) {
        ...
        String opcaoMenuGeral = JOptionPane.showInputDialog(null,
                "Digite\n" +
                        "1 - Cliente\n" +
                        "2 - Produto", "Cadastro", JOptionPane.INFORMATION_MESSAGE);
